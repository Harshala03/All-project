            ...
            <div class="p-6 rounded-md bg-green-600/10 dark:bg-green-600/20">
                <div class="md:flex items-center">
                    ...
                    <div class="md:ms-4 md:mt-0 mt-4 md:flex justify-between items-end">
                        <div>
                            <h5 class="text-2xl font-medium">{{data?.name ? data?.name :'Amber Durden'}} <span
                                    class="text-base md:inline block md:mt-0 mt-2"><span class="text-slate-400"><span
                                        ...
                                        Broker</span> of <router-link to="/agency-profile"
                                        class="hover:text-green-600">Highrises Realty</router-link></span></h5>
...
import image from '../assets/images/client/03.jpg'
